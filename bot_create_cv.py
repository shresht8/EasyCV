...
class BotCreateCV():
    ...
    def read_job_desc(self):
        ...
        with open(os.path.join(self.cv_template_path, 'job_description.txt'), 'w') as file:
            self.job_desc_str = file.read()

    def scrape_job_desc(self):
        """Scrapes job data from link and """
        if not os.path.exists(os.path.join(self.cv_template_path, 'job_description.txt')):
    ...
    def generate_cv(self):
        ...
        CV_EXPERT_BOT = CVExpertBot(self.user_name,
                                    self.user_info_str,
                                    self.job_desc_str,
                                    self.latex_content)
...
if __name__ == '__main__':
    ...
    bot_create_cv = BotCreateCV(args.arg1,
                                args.arg2,
                                args.arg3,
                                args.arg4)
    print("args passed")
